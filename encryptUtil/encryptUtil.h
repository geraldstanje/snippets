...
private:
  ...
  void xor_encrypt_chunk(std::vector<BYTE> &stream_buffer, long first_proc_chunk, long number_of_bytes);
  void xor_encrypt_chunk(std::vector<BYTE> &stream_buffer, long first_proc_chunk, long number_of_bytes, long number_of_already_proc_bytes, long thread_id);
  ...
  void thread_function(std::vector<BYTE> &stream_buffer, long first_processed_chunk, long number_of_bytes, long number_of_already_proc_bytes, long thread_id);
